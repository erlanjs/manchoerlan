            ...
            <div className="bg-[#1F1F1F] w-full h-[280px]">
                <div className="container mx-auto w-[90%] pt-[64px]">
                    ...
                    <StaticImage
                        ...
                        alt=""
                        className="absolute mt-[10px] ml-[700px] z-10 w-[588px] h-[555px] phoneMin:ml-0 phoneMin:right-0 phoneMin:w-[65%] phoneMin:h-[84%]  phoneMax:ml-0 phoneMax:right-0 phoneMax:w-[75%] phoneMax:h-[84%] tablet:ml-0 tablet:w-[70%] tablet:right-0 tablet:h-[84%] laptop:left-[580px] laptop:w-[460px] laptop:h-[430px] desktop:left-[680px] desktop:w-[588px] desktop:h-[555px]"
                    />
